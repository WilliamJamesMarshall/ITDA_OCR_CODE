...
def main():
    ...
    # Intentional REVIEW/barcode exclusions can reduce frozen exact matches.
    # Keep every lost ID; never treat abstention as a correct date prediction.
    ...
    result['additional_source_sha256']={'src/ocr_trace.py':hashlib.sha256((ROOT/'src/ocr_trace.py').read_bytes()).hexdigest()}
