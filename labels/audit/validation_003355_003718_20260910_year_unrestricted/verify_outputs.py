...
original=openpyxl.load_workbook(Path('C:/ITDA_OCR_WORKTREES/lee-hoyeon/labels/validation_003355_003718_manual.xlsx'),data_only=False)
...
for stage in ('baseline','p3'):
    path=LABELS/f'validation_003355_003718_{stage}_20260910.xlsx'
