...
stages = ['baseline','p1_replay','p2_replay','p3_replay','p3']
result = {}
detail = {}
for stage in stages:
    ...
    filename = f'validation_003353_003716_{stage}_20260909.csv'
    ...
    result[stage] = {'total':n,'correct':correct,'incorrect':n-correct,'accuracy':rate,
                     'wilson_95':[center-half,center+half], 'categories':groups,'error_types':errors,
