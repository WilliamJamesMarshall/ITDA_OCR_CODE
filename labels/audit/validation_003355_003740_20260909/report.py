...
assert set(scores) == {'baseline','p1_replay','p2_replay','p3_replay','p3'}
...
comparisons={f'{a}_to_{b}':compare(a,b) for a,b in [('baseline','p1_replay'),('p1_replay','p2_replay'),('p2_replay','p3_replay'),('p3_replay','p3')]}
...
'- 따라서 운영 반영 승인은 하지 않았다. 과거 연도·부분 날짜의 입출력 계약을 먼저 정리하고, 날짜 순서의 모호함과 낮은 신뢰도 날짜 쌍 선택을 보완한 뒤 기존 검증셋도 다시 평가해야 한다.',
...
'## 6. 저장 파일',
'',
'baseline과 p3의 새 XLSX는 원본 시트명·8열·정답·True/False 비교 수식을 유지했다. 각 단계의 CSV도 같은 8열을 사용한다. 실행 로그·측정 환경·채점 근거·테스트 결과·재현 코드는 labels/audit/validation_003355_003740_20260909에 있다.',
'']
target=LABELS/'validation_003355_003740_report_20260909.md'
