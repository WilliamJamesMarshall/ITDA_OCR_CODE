...
OLD=LABELS/'audit/validation_003355_003740_20260910'
NEW=LABELS/'audit/validation_003355_003740_20260910_year_unrestricted'
...
if len(sys.argv)>1 and sys.argv[1]=='collect':
    ...
    assert len(raw)==386 and {r['image_id'] for r in raw}=={f'{i:06d}' for i in range(3355,3741)}
...
ws=openpyxl.load_workbook(LABELS/'validation_003355_003740_manual.xlsx',data_only=True).active
assert len(truth)==386 and ws.max_row==387
...
files=[p for p in LABELS.glob('validation_003355_003740_*20260910*') if p.is_file()]
...
for stage in ('baseline','p3'):
    assert previous[f'validation_003355_003740_{stage}_20260910.xlsx']==verification[stage]['sha256'], 'Result workbook changed since last verification'
