...
OLD=LABELS/'audit/validation_003353_003716_20260910'
NEW=LABELS/'audit/validation_003353_003716_20260910_year_unrestricted'
...
if len(sys.argv)>1 and sys.argv[1]=='collect':
    ...
    assert len(raw)== 364 and {r['image_id'] for r in raw}=={f'{i:06d}' for i in range(3353, 3717)}
...
ws=openpyxl.load_workbook(LABELS/'validation_003353_003716_manual.xlsx',data_only=True).active
...
files=[p for p in LABELS.glob('validation_003353_003716_*20260910*') if p.is_file()]
...
for stage in ('baseline','p3'):
    assert previous[f'validation_003353_003716_{stage}_20260910.xlsx']==verification[stage]['sha256'], 'Result workbook changed since last verification'
