...
OUT = Path('C:/ITDA_OCR_WORKTREES/lee-hoyeon/labels/audit/validation_003353_003716_20260910_year_unrestricted')
...
images = [Path('C:/ITDA_OCR_CODE/추가수집데이터') / f'{i:06d}.jpg' for i in range(3353, 3717)]
