...
const source=path.join(labels,'validation_003355_003740_manual.xlsx');
...
for(const stage of ['baseline','p3']){
  ...
  const inspection=[{kind:'workbook',source:target,sha256:sha,sheets:1,rows:387,dataRows:386,columns:8},
