...
OLD = OUT.with_name('validation_003355_003740_20260909')
ROOT = OUT.parents[2]
def digest(path):
...
wb = openpyxl.load_workbook(OUT.parents[1]/'validation_003355_003740_manual.xlsx',data_only=True)
sheet = wb['검수 정답지']
...
assert len(logs)==386 and {r['image_id'] for r in logs}==set(manifest['images'])
